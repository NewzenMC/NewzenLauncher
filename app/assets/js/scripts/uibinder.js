...
/**
 * Show a Toast
 * @param {String} type Type of the Toast, can be `success`, `error`, `warning` or `info`,
 * @param {String} message Toast Message
 * @param {Number} [timer] Time in Milliseconds before auto-dismiss
 * @return {Promise<void>} Promise resolved when the Toast is Dismissed
 */
    ...
    <div class="toast-container ${type}-bg">
      <div>
        <div class="toast-frame">
          <img class="toast-img" src="assets/images/cute-toasts/${type}.svg" />
